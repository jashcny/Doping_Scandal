function top8Rule_Anabolic (data){

           var fullwidth = 920,
               fullheight = 350;

           var margin = {top: 30, right:1, bottom: 10, left: 215},
           ...
           var anaObj = data.filter(function(d){
                                return (d.rule != "ABP Case"&& d.rule !="EPO")
                            });

           console.log("anaObj");

           var svg = d3.select("#top8Rule").append("svg")
                       .attr("class", "barsvg")
